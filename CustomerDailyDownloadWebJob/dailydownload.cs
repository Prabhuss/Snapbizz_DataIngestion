...
namespace CustomerDailyDownloadWebJob
{
    class dailydownload
    {
        ...
        static void doJob()
        {
            ...
            string[] invoiceList = new string[] { "customers" };
...

        {
            ...
            mail.Subject = " customer web job  notification";
            if (result == 1)
            {
        ...
        public static int InsertDataIntoSQLServerUsingSQLBulkCopy(DataTable csvFileData)
        {
            ...
            try
            {
                ...
                using (SqlConnection dbConnection = new SqlConnection(connection1))
                {
                    ...
                    {
                        s.DestinationTableName = "sb_customer";
                        s.BatchSize = 500;

                        foreach(var col in csvFileData.Columns)
                        {
