...
namespace sasAzureblob
{
    public class dailydownload
    {
        ...
        static void doJob()
        {
            ...
            string[] invoiceList = new string[] { "distributors" };
...

        {
            ...
            mail.Subject = " distributor web job  notification";
                if (result == 1)
                {
        ...
        public static int InsertDataIntoSQLServerUsingSQLBulkCopy(DataTable csvFileData)
        {
            ...
            try
            {
                ...
                using (SqlConnection dbConnection = new SqlConnection(connection1))
                {
                    ...
                    {
                        s.DestinationTableName = "sb_distributor_table";
                        s.BatchSize = 500;
                        ...
                        s.ColumnMappings.Add("is_disabled", "is_disabled");
                        ...
                        if (csvFileData.Columns.Contains("gstin"))
                        {
                            s.ColumnMappings.Add("gstin", "gstin");
